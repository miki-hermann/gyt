...
void read_input (polynomial &p, unsigned long long &B) {
  cout << "Sequential All-Solution Multidimensional Generalized Young Tableaux"
       << endl;
  cout << "==================================================================="
       << endl;
  cout << endl;
...
bool test_bound (const val_tuple &val, const val_tuple &bound) {
...
int main(int argc, char **argv) {
  ...
  while (!stck.empty()) {
    ...
    while (test_bound(val, bound) && val[p.k-1] >= 0) {
