// Compile with 'g++ -O4 -o young-gmp young-gmp.cpp -lgmpxx -lgmp'
...
void read_input (polynomial &p, mpz_class &B) {
  cout << "Sequential Multidimensional Multiprecision Generalized Young Tableaux"
       << endl;
  cout << "====================================================================="
       << endl;
  cout << endl;
...
int main(int argc, char **argv) {
  ...
  cout << "    stack residue   = " << stck.size() << endl;
